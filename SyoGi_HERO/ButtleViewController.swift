...
class ButtleViewController: UIViewController {
    ...
    func handAdd2(handNumber : Int){
        for x in 0...2{
            if play2Hold[x] == 0 && handNumber > 1{
                play2Hold[x] = handNumber * -1
                break
            }
        }
        if handNumber == 1{
    ...
    func plotHandKoma(){//駒の画像をプロット
        for x in 1...7{//駒が追加されたらこのfar文も長くする
            if play1Hold[0] == x {
    ...
    func searchCanPut2(flag : Int){
        ...
        if possiblePutMatrix[3][0] == 1 {buttns10.backgroundColor = UIColor.blue}else{buttns10.backgroundColor = UIColor.brown}
        if possiblePutMatrix[3][1] == 1 {buttns11.backgroundColor = UIColor.blue}else{buttns11.backgroundColor = UIColor.brown}
        if possiblePutMatrix[3][2] == 1 {buttns12.backgroundColor = UIColor.blue}else{buttns12.backgroundColor = UIColor.brown}
        if possiblePutMatrix[4][0] == 1 {buttns13.backgroundColor = UIColor.blue}else{buttns13.backgroundColor = UIColor.brown}
        if possiblePutMatrix[4][1] == 1 {buttns14.backgroundColor = UIColor.blue}else{buttns14.backgroundColor = UIColor.brown}
        if possiblePutMatrix[4][2] == 1 {buttns15.backgroundColor = UIColor.blue}else{buttns15.backgroundColor = UIColor.brown}
        if possiblePutMatrix[5][0] == 1 {buttns16.backgroundColor = UIColor.blue}else{buttns16.backgroundColor = UIColor.brown}
        if possiblePutMatrix[5][1] == 1 {buttns17.backgroundColor = UIColor.blue}else{buttns17.backgroundColor = UIColor.brown}
        if possiblePutMatrix[5][2] == 1 {buttns18.backgroundColor = UIColor.blue}else{buttns18.backgroundColor = UIColor.brown}
        if possiblePutMatrix[6][0] == 1 {buttns19.backgroundColor = UIColor.blue}else{buttns19.backgroundColor = UIColor.brown}
        if possiblePutMatrix[6][1] == 1 {buttns20.backgroundColor = UIColor.blue}else{buttns20.backgroundColor = UIColor.brown}
        if possiblePutMatrix[6][2] == 1 {buttns21.backgroundColor = UIColor.blue}else{buttns21.backgroundColor = UIColor.brown}
        if possiblePutMatrix[7][0] == 1 {buttns22.backgroundColor = UIColor.blue}else{buttns22.backgroundColor = UIColor.brown}
        if possiblePutMatrix[7][1] == 1 {buttns23.backgroundColor = UIColor.blue}else{buttns23.backgroundColor = UIColor.brown}
        if possiblePutMatrix[7][2] == 1 {buttns24.backgroundColor = UIColor.blue}else{buttns24.backgroundColor = UIColor.brown}
    ...
    @IBAction func summon5(){
        if play2Hold[0] != 0{
            handButtns1.backgroundColor = UIColor.blue
    ...
    @IBAction func summon6(){
        if play2Hold[1] != 0{
            handButtns2.backgroundColor = UIColor.blue
    ...
    @IBAction func summon7(){
        if play2Hold[2] != 0{
            handButtns3.backgroundColor = UIColor.blue
    ...
    @IBAction func summon8(){
        if play2Hold[3] != 0{
            handButtns4.backgroundColor = UIColor.blue
